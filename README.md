...
- [ ] Составить краткое описание того, как будет выглядеть готовый проект
...
- [ ] Реализовать необходимые функции приложения
- [ ] Реализовать регистрацию/авторизации пользователя
