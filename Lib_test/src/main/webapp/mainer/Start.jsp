    ...
    <body>
        ...
        <header>
            <div class="header_area">
                ...
                <a href="signin.jsp" class="sign_in_btn">Log in</a>
        ...
        <div class="mobile_nav">
            ...
            <div class="mobile_nav_items">
                 <button value = "Start" name = "act" ><div id="sidebar_button"><i class="fas fa-home"></i><span>Home</span></div></button>
                <button value = "Book_BD" name = "act" ><div id="sidebar_button"><i class="far fa-question-circle"></i><span>About</span></div></button>
